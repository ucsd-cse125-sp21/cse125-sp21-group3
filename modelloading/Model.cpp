...
void Model::processNode(aiNode* node, const aiScene* scene, glm::mat4 parentTransform)
{
    ...
    for (unsigned int i = 0; i < node->mNumMeshes; i++)
    {
        ...
        glm::mat4 model = parentTransform * localTransform;
...
Mesh Model::processMesh(aiMesh* mesh, const aiScene* scene, glm::mat4 model)
{
    ...
    // 1. diffuse maps
    /*cout << "material has " << material->mNumProperties << " properties." << endl;
    for (int i = 0; i < material->mNumProperties; i++) {
        cout << "material property[" << i << "]: " << material->mProperties[i]->mKey.C_Str() << endl;   
    ...
    //cout << "material" << material->mProperties[0]->mKey.C_Str() << endl;
